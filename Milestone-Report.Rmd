...
bi <- ggplot(bigram[1:10,], aes(x=reorder(bigram, Freq), y=Freq, fill = Freq)) +
        scale_fill_gradient(low = "#56B1F7", high = "#132B43",)+
        geom_bar(stat = "identity")+ 
        coord_flip()+
...
tri <- ggplot(trigram[1:10,], aes(x=reorder(trigram, Freq), y=Freq, fill = Freq)) +
        scale_fill_gradient(low = "#56B1F7", high = "#132B43",)+
        geom_bar(stat = "identity")+ 
        coord_flip()+
...
qua <- ggplot(quadgram [1:10,], aes(x=reorder(quadgram , Freq), y=Freq, fill = Freq)) +
        scale_fill_gradient(low = "#56B1F7", high = "#132B43",)+
        geom_bar(stat = "identity")+ 
        coord_flip()+
